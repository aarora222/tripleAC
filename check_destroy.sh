...
if [[ $(grep -c "Attacker closed the connection" "$2"/mitm.log) -ge 1 ]]
then
...
then
  ...
  sed -n "/D $3/p" /home/student/not_free_ip_file.txt >> /home/student/free_ip_file.txt
  # delete line from not free ip
  sed -i "/D $3/d" /home/student/not_free_ip_file.txt
